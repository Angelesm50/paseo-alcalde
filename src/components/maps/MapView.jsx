...
const MapView = () => {
  ...
  useEffect(() => {
    ...
    const place = distanceInMeter.find(place => place.distance >= 0 && place.distance <= 10);
  ...
  return (
    <MapContainer style={ { width: "100%", height: "300px" } } center={ [20.536937821169772, -103.96649936013992] } zoom={ 16 }>
      <TileLayer
